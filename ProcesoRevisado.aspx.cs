...
{
    public partial class ProcesoRevisado : Page
    {
        DateTime FECHA;
        DateTime FIN;
        string VENDEDOR;
        ...
        protected void descarga1(object sender, EventArgs e)
        {
            ...
            string query2 = "select  NombreComercial, NumeroCertificado, Nombre, Cedula, FechaVenta, Ejecutivo, Digitador from Asegurados where Proceso='REVISADO' AND NumeroCertificado is not null"; 
