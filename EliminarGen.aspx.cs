...
{
    public partial class EliminarGen : Page
    {
        DateTime FECHA;
        DateTime FIN;
        string VENDEDOR;
        ...
        protected void descarga1(object sender, EventArgs e)
        {
            ...
            string query2 = "select  NombreComercial, NumeroCertificado, Nombre, Cedula, FechaVenta, Ejecutivo, Digitador from Asegurados where NumeroCertificado is null"; 
                    ...
                    if (dr2.Read())
                    {
                        ...
                        else
                        {
                            using (XLWorkbook wb = new XLWorkbook())
                            {
                                ...
                                Response.AddHeader("content-disposition", "attachment;filename=RgistrosInconclusos.xlsx");
