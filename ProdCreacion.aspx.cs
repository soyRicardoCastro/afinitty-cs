    ...
    public partial class ProdCreacion : Page
    {
        ...
        protected void Unnamed_Click(object sender, EventArgs e)
        {
                    ...
                    using (SqlConnection openCon = new SqlConnection(Conection.ConexLine))
                    {
                        ...
                        using (SqlCommand querySaveStaff = new SqlCommand(saveStaff))
                        {
                            ...
                            try
                            {
                                ...
                                Page.RegisterStartupScript("LoadFunction", "<script type='text/javascript'>alert('PRODUCTO EDITADO CON EXITO');window.location='ProdListaEdic.aspx'</script>");
            ...
            else
            {
                using (SqlConnection openCon = new SqlConnection(Conection.ConexLine))
                {
                    string saveStaff = "INSERT into Productos (Producto, PlanSelect, Edadmin, Edadmax, Edadren, Aplica, Cobertura, Valor, Causa, Medio) VALUES (@Producto, @PlanSelect, @Edadmin, @Edadmax, @Edadren, @Aplica, @Cobertura, @Valor, @Causa, 'WSM')";
