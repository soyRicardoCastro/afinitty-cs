<%@ Page Title="Tarrago Reach System" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteEstCert.aspx.cs" Inherits="ReachSystem.ReporteEstCert" %>
    ...
    <div class="card">
        ...
        <div class="card-body">
                <div class="form-row">
                    <table style="width: 100%;">
                        <tr>  
                            ...
                            <td><asp:Label ID="Label4" runat="server" Text="ESTADO" Style="font-weight: bold; font-size: 18px;"></asp:Label><br />
                                ...
                                <asp:SqlDataSource runat="server" ID="SqlDataSource2" ConnectionString='<%$ ConnectionStrings:affisDBConnectionString %>' SelectCommand="SELECT DISTINCT [Estado] FROM [Asegurados] WHERE ([Estado] IS NOT NULL)"></asp:SqlDataSource>
                            </td>
                    ...
                    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:affisDBConnectionString %>' SelectCommand="SELECT [Nombre], [Cedula], [NombreComercial], [MedioDeCobro], [TotalCobrar], Estado FROM [Asegurados] WHERE ([NumeroCertificado] IS NOT NULL) AND fechaventa BETWEEN @fechaini AND @fechafin AND Estado = @est">
                        <SelectParameters>                                
                            ...
                            <asp:CookieParameter CookieName="paramEST" Name="est" Type="String"></asp:CookieParameter> 
                        </SelectParameters>
                    </asp:SqlDataSource>
                </div>
