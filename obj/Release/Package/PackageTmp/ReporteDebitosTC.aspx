<%@ Page Title="Tarrago Reach System" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteDebitosTC.aspx.cs" Inherits="ReachSystem.ReporteDebitosTC" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server"> 
    ...
    <div class="card">
        <div class="card-header">
                <div class="form-row">
                    <div class="col10L">                        
                        <asp:Label ID="Label6" runat="server" Text="REPORTE: DEBITOS BANCARIOS TC" Style="font-weight: bold; font-size: 18px;"></asp:Label>                        
                    </div>                   
                </div>
            </div>
        <div class="card-body">
                <div class="form-row">
                    <table style="width: 100%;">
                        <tr>  
                            ...
                            <td><asp:Label ID="Label4" runat="server" Text="EMPRESA" Style="font-weight: bold; font-size: 18px;"></asp:Label><br />
                                ...
                                <asp:SqlDataSource runat="server" ID="SqlDataSource2" ConnectionString='<%$ ConnectionStrings:affisDBConnectionString %>' SelectCommand="SELECT DISTINCT NombreComercial FROM Asegurados Where (Estado='VENTA' AND MedioDeCobro = 'AMBOS') or (Estado='VENTA' AND MedioDeCobro = 'TARJETA DE CREDITO')"></asp:SqlDataSource>
                            </td>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True" GridLines="None" BackColor="White" BorderStyle="None" BorderWidth="1px" CellPadding="20" ForeColor="Black" CssClass="mGrid" PagerStyle-CssClass="pgr" margin-left="2%" AlternatingRowStyle-CssClass="alt" AllowSorting="True" DataSourceID="SqlDataSource1" PageSize="100">
                        <Columns>
                            ...
                            <asp:BoundField DataField="Vencimiento" HeaderText="VENCIMIENTO" SortExpression="Vencimiento"></asp:BoundField>  
                            <asp:BoundField DataField="NumeroTar" HeaderText="NUMERO TARJETA" SortExpression="NumeroTar"></asp:BoundField>                            
                            <asp:BoundField DataField="Total" HeaderText="TOTAL A DESCONTAR" SortExpression="Total"></asp:BoundField>
                            <asp:BoundField DataField="CodigoSeguridad" HeaderText="CODIGO SEGURIDAD" SortExpression="CodigoSeguridad"></asp:BoundField>  
                            <asp:BoundField DataField="Tarjeta" HeaderText="TARJETA" SortExpression="Tarjeta"></asp:BoundField>  
                    ...
                    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:affisDBConnectionString %>' SelectCommand="Select distinct a.NombreComercial, b.Clase, b.Poliza, a.Nombre, a.Vencimiento ,a.NumeroTar, SUM(a.TotalCobrar) OVER(PARTITION BY a.Cedula) as Total, a.CodigoSeguridad, a.Tarjeta, a.banco from Asegurados a Join Empresa b on a.NombreComercial = b.NombreComercial WHERE a.FechaVigencia BETWEEN @fechaini AND @fechafin AND a.Estado = 'VENTA' AND a.NombreComercial = @ven AND Tarjeta <> ''"> 
                        <SelectParameters>                                
