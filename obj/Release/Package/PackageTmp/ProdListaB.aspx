<%@ Page Title="Tarrago Reach System" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProdListaB.aspx.cs" Inherits="ReachSystem.ProdListaB" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server"> 
    ...
    <div class="card">
        <div class="card-header">
                <div class="form-row">
                    <div class="col10L">                        
                        <asp:Label ID="Label6" runat="server" Text="PRODUCTOS BANCA SEGUROS: LISTA" Style="font-weight: bold; font-size: 18px;"></asp:Label>                         
                    </div>                   
                </div>
            </div>
        <div class="card-body">
...
<PagerStyle CssClass="pgr"></PagerStyle>
                    ...
                    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:affisDBConnectionString %>' SelectCommand="SELECT [Producto], [PlanSelect], [Edadmin], [Edadmax], [Edadren], [Aplica], [Valor], [Cobertura], [Causa] FROM [Productos] WHERE Medio = 'BANCA'">
                    </asp:SqlDataSource>       
                    <hr />
                    <CENTER>
