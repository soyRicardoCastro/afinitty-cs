...
<PagerStyle CssClass="pgr"></PagerStyle>
                    ...
                    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:affisDBConnectionString %>' SelectCommand="SELECT [Ejecutivo], [Nombre], [NumeroCertificado], [Proceso], NombreComercial, FechaVenta FROM [Asegurados] WHERE NumeroCertificado IS NOT NULL AND (([Cedula] = @Cedula) AND Proceso IS NOT NULL and Estado<>'EXCLUIDO')OR (([NumeroCertificado] = @NumeroCertificado ) AND Proceso IS NOT NULL and Estado<>'EXCLUIDO')">
                        <SelectParameters>                            
...
<PagerStyle CssClass="pgr"></PagerStyle>
                    ...
                    <asp:SqlDataSource runat="server" ID="SqlDataSource2" ConnectionString='<%$ ConnectionStrings:affisDBConnectionString %>' SelectCommand="SELECT [Ejecutivo], [Nombre], [NumeroCertificado], [Proceso], NombreComercial, FechaVenta FROM [Asegurados] WHERE NumeroCertificado IS NOT NULL AND Proceso IS NOT NULL AND PROCESO <> 'REVISADO' and Estado<>'EXCLUIDO'">
