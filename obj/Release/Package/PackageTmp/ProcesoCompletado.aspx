<%@ Page Title="Tarrago Reach System" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProcesoCompletado.aspx.cs" Inherits="ReachSystem.ProcesoCompletado" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server"> 
    ...
    <div class="card">
        <div class="card-header">
                <div class="form-row">
                    <div class="col10L">                        
                        <asp:Label ID="Label6" runat="server" Text="CERTIFICADOS COMPLETADOS" Style="font-weight: bold; font-size: 18px;"></asp:Label>                        
                    </div>                   
                </div>
            </div>
        <div class="card-body">
    ...
    <asp:BoundField DataField="Digitador" HeaderText="Digitador" SortExpression="Digitador"></asp:BoundField>
                    ...
                    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:affisDBConnectionString %>' SelectCommand="select  NombreComercial, NumeroCertificado, Nombre, Cedula, FechaVenta, Ejecutivo, Digitador from Asegurados where proceso='COMPLETADO' AND NumeroCertificado is not null"> 
