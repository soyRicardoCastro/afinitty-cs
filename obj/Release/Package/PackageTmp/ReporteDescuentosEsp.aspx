<%@ Page Title="Tarrago Reach System" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteDescuentosEsp.aspx.cs" Inherits="ReachSystem.ReporteDescuentosEsp" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server"> 
    ...
    <div class="card">
        <div class="card-header">
                <div class="form-row">
                    <div class="col10L">                        
                        <asp:Label ID="Label6" runat="server" Text="REPORTE: DESCUENTOS ESPECIFICO" Style="font-weight: bold; font-size: 18px;"></asp:Label>                        
                    </div>                   
                </div>
            </div>
        <div class="card-body">
                <div class="form-row">
                    <table style="width: 100%;">
                        <tr>  
                            ...
                            <td><asp:Label ID="Label4" runat="server" Text="EMPRESA" Style="font-weight: bold; font-size: 18px;"></asp:Label><br />
                                <asp:DropDownList ID="DropDownList1" runat="server" class="formularioProc" DataSourceID="SqlDataSource2" DataTextField="Empresa" DataValueField="Empresa"></asp:DropDownList>
                                <asp:SqlDataSource runat="server" ID="SqlDataSource2" ConnectionString='<%$ ConnectionStrings:affisDBConnectionString %>' SelectCommand="SELECT DISTINCT Empresa FROM Morosos"></asp:SqlDataSource>
                            </td>
                    ...
                    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:affisDBConnectionString %>' SelectCommand="select distinct ROW_NUMBER() OVER(ORDER BY a.Ceudla ASC) as Numero, b.Codigo, a.Nombre, a.Ceudla, a.Mes, a.Total from Morosos a Join Asegurados b on b.Cedula = a.Ceudla WHERE a.Empresa = @ven AND b.Estado = 'VENTA' and a.Mes <> '' group by b.Cedula, a.Ceudla, b.Codigo, a.Nombre, a.Mes, a.Total"> <%--FechaVigencia BETWEEN @fechaini AND @fechafin AND Estado = 'VENTA'FechaVigencia BETWEEN @fechaini AND @fechafin AND Estado = 'VENTA'--%>
                        <SelectParameters>                                
