<%@ Page Title="Tarrago Reach System" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteExclusionesFinal.aspx.cs" Inherits="ReachSystem.ReporteExclusionesFinal" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server"> 
    ...
    <div class="card">
        <div class="card-header">
                <div class="form-row">
                    <div class="col10L">                        
                        <asp:Label ID="Label6" runat="server" Text="REPORTE: EXCLUSIONES" Style="font-weight: bold; font-size: 18px;"></asp:Label>                        
                    </div>                   
                </div>
            </div>
        <div class="card-body">
                <div class="form-row">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True" GridLines="None" BackColor="White" BorderStyle="None" BorderWidth="1px" CellPadding="20" ForeColor="Black" CssClass="mGrid" PagerStyle-CssClass="pgr" margin-left="2%" AlternatingRowStyle-CssClass="alt" AllowSorting="True" DataSourceID="SqlDataSource1" PageSize="100">
                        <Columns>
                            ...
                            <asp:BoundField DataField="FechaVenta" HeaderText="FECHA VENTA" SortExpression="FechaVenta"></asp:BoundField>
                           ...
                           <asp:BoundField DataField="Retencion" HeaderText="RESULTADO" SortExpression="Retencion"></asp:BoundField>    
                    ...
                    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:affisDBConnectionString %>' SelectCommand="SELECT NombreComercial, Nombre, NumeroCertificado, TotalCobrar, FechaVenta, Ejecutivo, Responsable, Motivo, Retencion, procesoWSM FROM asegurados where (Retencion is not null and Retencion <> 'SOLICITADO' AND FechaRet BETWEEN @fechaini AND @fechafin AND NumeroCertificado is not null) OR (Estado = 'EXCLUIDO' AND FechaReemplazo BETWEEN @fechaini AND @fechafin AND Retencion is not null and Retencion <> 'SOLICITADO')"> 
                        <SelectParameters>                                
