<%@ Page Title="Tarrago Reach System" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteDebitosCTA.aspx.cs" Inherits="ReachSystem.ReporteDebitosCTA" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server"> 
    ...
    <div class="card">
        <div class="card-header">
                <div class="form-row">
                    <div class="col10L">                        
                        <asp:Label ID="Label6" runat="server" Text="REPORTE: DEBITOS BANCARIOS CTA" Style="font-weight: bold; font-size: 18px;"></asp:Label>                        
                    </div>                   
                </div>
            </div>
        <div class="card-body">
                <div class="form-row">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True" GridLines="None" BackColor="White" BorderStyle="None" BorderWidth="1px" CellPadding="20" ForeColor="Black" CssClass="mGrid" PagerStyle-CssClass="pgr" margin-left="2%" AlternatingRowStyle-CssClass="alt" AllowSorting="True" DataSourceID="SqlDataSource1" PageSize="100">
                        <Columns>
                            ...
                            <asp:BoundField DataField="Cuenta" HeaderText="CUENTA NUMERO" SortExpression="Cuenta"></asp:BoundField> 
                            <asp:BoundField DataField="TipoCuenta" HeaderText="TIPO DE CUENTA" SortExpression="TipoCuenta"></asp:BoundField>  
                    ...
                    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:affisDBConnectionString %>' SelectCommand="Select distinct b.Poliza, b.Clase, a.Nombre, a.NombreComercial, a.Cuenta, a.TipoCuenta, SUM(a.TotalCobrar) OVER(PARTITION BY a.Cedula) as Total, a.Cedula, a.banco from Asegurados a Join Empresa b on a.NombreComercial = b.NombreComercial WHERE a.FechaVigencia BETWEEN @fechaini AND @fechafin AND a.Estado = 'VENTA' AND a.NombreComercial = @ven AND a.Cuenta <> ''"> 
                        <SelectParameters>                                
