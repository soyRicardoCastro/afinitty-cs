...
{
    public partial class ReporteExclusionesFinal : Page
    {
        DateTime FECHA;
        DateTime FIN;
        //string VENDEDOR;
        ...
        protected void Unnamed_Click1(object sender, EventArgs e)
        {
            ...
            Response.Redirect("ReporteExclusionesFinal.aspx");
        }
        protected void descarga1(object sender, EventArgs e)
        {
            string connectionString2 = Conection.ConexLine;
            string query2 = "SELECT NombreComercial, Nombre, NumeroCertificado, TotalCobrar, FechaVenta, Ejecutivo, Responsable, Motivo, procesoWSM, Retencion  FROM asegurados where Retencion is not null and Retencion <> 'SOLICITADO' AND FechaRet BETWEEN @fechaini AND @fechafin AND NumeroCertificado is not null"; 
                    ...
                    if (dr2.Read())
                    {
                        ...
                        else
                        {
                            using (XLWorkbook wb = new XLWorkbook())
                            {
                                ...
                                Response.AddHeader("content-disposition", "attachment;filename=ReporteExclusiones.xlsx");
