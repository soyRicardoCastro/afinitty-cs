...
{
    public partial class ProcesoCompletado : Page
    {
        DateTime FECHA;
        DateTime FIN;
        string VENDEDOR;
        ...
        protected void descarga1(object sender, EventArgs e)
        {
            ...
            string query2 = "select  NombreComercial, NumeroCertificado, Nombre, Cedula, FechaVenta, Ejecutivo, Digitador from Asegurados where Proceso='COMPLETADO' AND NumeroCertificado is not null"; 
