...
{
    public partial class ReporteCasos : Page
    {
        DateTime FECHA;
        DateTime FIN;
        string VENDEDOR;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.Cookies["ParamIni"] != null)
            {
                ...
                string query = "Select SUM(PagoAseg)  FROM [Reclamos] WHERE [Fecha] BETWEEN @fechaini AND @fechafin AND [Entidad] = @ven";
                    ...
                    if (dr2.Read())
                    {
                        ...
                        else
                        {
                            using (XLWorkbook wb = new XLWorkbook())
                            {
                                ...
                                Response.AddHeader("content-disposition", "attachment;filename=ReporteCasos.xlsx");
