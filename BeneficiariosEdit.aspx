<%@ Page Title="Tarrago Reach System" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BeneficiariosEdit.aspx.cs" Inherits="ReachSystem.BeneficiariosEdit" %>
    ...
    <div class="card">
        ...
        <div class="card-body">
                <div class="form-row">                           
                    ...
                    <asp:Label ID="Label4" runat="server" Text="BENEFICIARIOS LISTA" Style="font-weight: bold; font-size: 18px;"></asp:Label> 
                    <hr />
                    ...
                    <asp:Button  value="REGISTRARME" type="submit" runat="server" CssClass="botonsubmitTRES" Text="VOLVER" OnClick="Unnamed_Click"/>                                                  
                        <asp:Button  value="REGISTRARME" type="submit" runat="server" CssClass="botonsubmitTRES" Text="GUARDAR" OnClick="Unnamed1_Click"/>                                                  
                    </CENTER>
                </div>
            </div>
        </div>
