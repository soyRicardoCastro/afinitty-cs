...
{
    public partial class ReporteCertificadosEntregados : Page
    {
        DateTime FECHA;
        DateTime FIN;
        string VENDEDOR;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //else if (Request.Cookies["ParamIniDos"] != null)
            //{
            //    FECHA = DateTime.Parse(Request.Cookies["paramIniDos"].Value);
            //    Text1.Value = "" + FECHA.Year + "-" + FECHA.Month.ToString("00") + "-" + FECHA.Day.ToString("00") + "";
            //    FIN = DateTime.Parse(Request.Cookies["paramFinDos"].Value);
            //    Correo.Value = "" + FIN.Year + "-" + FIN.Month.ToString("00") + "-" + FIN.Day.ToString("00") + "";
            //    VENDEDOR = Request.Cookies["paramVENDos"].Value;
            //    //ESTADO = Request.Cookies["paramEstado"].Value;
            //    //DropDownList1.SelectedValue = ESTADO;
            //    DropDownList2.SelectedValue = VENDEDOR;
        ...
        protected void Unnamed_Click1(object sender, EventArgs e)
        {
            ...
            Response.Redirect("ReporteCertificadosEntregados.aspx");
        }
        protected void descarga1(object sender, EventArgs e)
        {
            string connectionString2 = Conection.ConexLine;
            string query2 = "Select a.NombreComercial, b.Clase, b.Poliza, a.NumeroCertificado, a.Nombre from Asegurados a join Empresa b  on a.NombreComercial = b.NombreComercial where a.Estado ='VENTA' and a.NumeroCertificado is not null AND a.fechaventa BETWEEN @Fecha AND @Fin AND b.Poliza=@Vent group by a.Nombre, a.NombreComercial, b.Clase, b.Poliza, a.NumeroCertificado order by a.NombreComercial asc"; 
                    ...
                    if (dr2.Read())
                    {
                        ...
                        else
                        {
                            using (XLWorkbook wb = new XLWorkbook())
                            {
                                ...
                                Response.AddHeader("content-disposition", "attachment;filename=ReporteEntregaCertificados.xlsx");
