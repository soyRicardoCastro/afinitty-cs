<%@Page Title="Tarrago Reach System" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EliminarPago.aspx.cs" Inherits="ReachSystem.EliminarPago" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server"> 
    ...
    <div class="card">
        <div class="card-header">
                <div class="form-row">
                    <div class="col10L">                        
                        <asp:Label ID="Label6" runat="server" Text="MANTENIMIENTO: ELIMINAR PAGO" Style="font-weight: bold; font-size: 18px;"></asp:Label>                        
                    </div>                   
                </div>
            </div>
        <div class="card-body">
...
<PagerStyle CssClass="pgr"></PagerStyle>
    ...
    <asp:BoundField DataField="MesFacturacion" HeaderText="Mes Facturacion" SortExpression="MesFacturacion"></asp:BoundField>
    ...
    <asp:CommandField SelectText="ELIMINAR" ShowSelectButton="True" ButtonType="Button"></asp:CommandField>
</Columns>
                        <FooterStyle BackColor="#CCCC99" ForeColor="Black" />
                            <HeaderStyle BackColor="white" Font-Bold="True" ForeColor="black" />
                            <PagerStyle BackColor="White" ForeColor="Black" HorizontalAlign="Right" />
...
<PagerStyle CssClass="pgr"></PagerStyle>
                    ...
                    <asp:SqlDataSource runat="server" ID="SqlDataSource2" ConnectionString='<%$ ConnectionStrings:affisDBConnectionString %>' SelectCommand="SELECT [RazonSocial], [MesFacturacion], [ValorFactura], [Deuda], Row FROM [Pagos]">

        <SelectParameters>
            <asp:Parameter DefaultValue="VIGENTE" Name="Status" Type="String"></asp:Parameter>
        </SelectParameters>
    </asp:SqlDataSource>
                    <hr />
