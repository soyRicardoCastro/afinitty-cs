...
{
    public partial class ReporteDescuentosEsp : Page
    {
        DateTime FECHA;
        DateTime FIN;
        string VENDEDOR;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.Cookies["ParamIni"] != null)
            {
                ...
                string query = "Select SUM(a.Total) from Morosos a Join Asegurados b on a.NumeroCertificado = b.NumeroCertificado where (b.NumeroCertificado IS NOT NULL) AND  a.Empresa=@Vent AND b.Estado = 'VENTA' and a.Mes <> ''"; /*AND FechaVigencia BETWEEN @Fecha AND @Fin AND Estado = 'VENTA'*/
        ...
        protected void Unnamed_Click1(object sender, EventArgs e)
        {
            ...
            Response.Redirect("ReporteDescuentosEsp.aspx");
        }
        protected void descarga1(object sender, EventArgs e)
        {
            string connectionString2 = Conection.ConexLine;
            string query2 = "select distinct ROW_NUMBER() OVER(ORDER BY a.Ceudla ASC) as Numero, b.Codigo, a.Nombre, a.Ceudla, a.Mes, a.Total from Morosos a Join Asegurados b on b.Cedula = a.Ceudla WHERE a.Empresa = @ven AND b.Estado = 'VENTA' and a.Mes <> '' group by b.Cedula, a.Ceudla, b.Codigo, a.Nombre, a.Mes, a.Total";
                    ...
                    if (dr2.Read())
                    {
                        ...
                        else
                        {
                            using (XLWorkbook wb = new XLWorkbook())
                            {
                                ...
                                Response.AddHeader("content-disposition", "attachment;filename=ReporteDescuentosEspecifico.xlsx");
