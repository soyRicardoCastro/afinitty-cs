...
{
    public partial class ReporteConsolidadoCobros : Page
    {
        DateTime FECHA;
        DateTime FIN;
        //string VENDEDOR;
                    ...
                    if (dr2.Read())
                    {
                        ...
                        else
                        {
                            using (XLWorkbook wb = new XLWorkbook())
                            {
                                ...
                                Response.AddHeader("content-disposition", "attachment;filename=ReporteConsolidadoCobros.xlsx");
