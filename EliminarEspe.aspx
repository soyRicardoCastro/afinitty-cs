<%@Page Title="Tarrago Reach System" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EliminarEspe.aspx.cs" Inherits="ReachSystem.EliminarEspe" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server"> 
    ...
    <div class="card">
        <div class="card-header">
                <div class="form-row">
                    <div class="col10L">                        
                        <asp:Label ID="Label6" runat="server" Text="MANTENIMIENTO: ELIMINAR REGISTRO ESPECIFICO" Style="font-weight: bold; font-size: 18px;"></asp:Label>                        
                    </div>                   
                </div>
            </div>
        <div class="card-body">
...
<PagerStyle CssClass="pgr"></PagerStyle>
                    ...
                    <asp:SqlDataSource runat="server" ID="SqlDataSource2" ConnectionString='<%$ ConnectionStrings:affisDBConnectionString %>' SelectCommand="SELECT [Ejecutivo], [Nombre], [NumeroCertificado], [Proceso], NombreComercial, FechaVenta FROM [Asegurados] WHERE NumeroCertificado IS NOT NULL AND Proceso IS NOT NULL ">
