<%@ Page Title="Tarrago Reach System" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteCobert.aspx.cs" Inherits="ReachSystem.ReporteCobert" %>
    ...
    <div class="card">
        ...
        <div class="card-body">
                <div class="form-row">
                    ...
                    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:affisDBConnectionString %>' SelectCommand="select Producto, sum(TotalPrima) as Total from Dependientes WHERE ([NumeroCertificado] IS NOT NULL) AND fechaventa BETWEEN @fechaini AND @fechafin group by Producto">
                        <SelectParameters>                                
