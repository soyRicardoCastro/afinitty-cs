...
{
    public partial class ReporteCierresFinal : Page
    {
        DateTime FECHA;
        DateTime FIN;
        string VENDEDOR;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.Cookies["ParamIni"] != null)
            {
                ...
                string query = "SELECT Sum(Monto) FROM [Cierres] WHERE Estado <> 'LIQUIDADO' and [Fecha] BETWEEN @fechaini AND @fechafin AND [Tipo] = @ven";
        ...
        protected void Unnamed_Click1(object sender, EventArgs e)
        {
            ...
            Response.Redirect("ReporteCierresFinal.aspx");
        }
        protected void descarga1(object sender, EventArgs e)
        {
            string connectionString2 = Conection.ConexLine;
            string query2 = "SELECT Empresa, Fecha, Monto, Tipo, Estado, Mes FROM [Cierres] WHERE Estado <> 'LIQUIDADO' and [Fecha] BETWEEN @fechaini AND @fechafin AND [Tipo] = @ven"; 
                    ...
                    if (dr2.Read())
                    {
                        ...
                        else
                        {
                            using (XLWorkbook wb = new XLWorkbook())
                            {
                                ...
                                Response.AddHeader("content-disposition", "attachment;filename=ReporteCierres.xlsx");
