<%@ Page Title="Tarrago Reach System" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteGenVen.aspx.cs" Inherits="ReachSystem.ReporteGenVen" %>
    ...
    <div class="card">
        ...
        <div class="card-body">
                <div class="form-row">
                    ...
                    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:affisDBConnectionString %>' SelectCommand="SELECT [Ejecutivo], [NumeroCertificado], [NombreComercial], [MedioDeCobro], [TotalCobrar], Estado FROM [Asegurados] WHERE ([NumeroCertificado] IS NOT NULL) AND fechaventa BETWEEN @fechaini AND @fechafin AND Estado = 'VENTA'">
                        <SelectParameters>                                
