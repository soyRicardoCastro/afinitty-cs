...
{
    public partial class ReporteEntregaPagos : Page
    {
        DateTime FECHA;
        DateTime FIN;
        //string VENDEDOR;
        ...
        protected void Unnamed_Click1(object sender, EventArgs e)
        {
            ...
            Response.Redirect("ReporteEntregaPagos.aspx");
        }
        protected void descarga1(object sender, EventArgs e)
        {
            string connectionString2 = Conection.ConexLine;
            string query2 = "select a.RazonSocial, b.Clase, b.Poliza, a.MesFacturacion, a.NumeroFactura, a.ValorFactura/10000, a.ValorNotaCred, (a.ValorFactura)/10000 - a.ValorNotaCred as NetoACobrar, a.Banco, a.Cuenta, a.NumCheque, a.ValorCheque, a.FechaTransf, a.Comprobante, a.ValorTransf, a.NumeroFactComi, a.ValorFactComi, a.NumeroReten, a.ValorRetenEmp, a.ValorDebito as ValorTotalPago, a.Deuda as Diferencia from pagos a join empresa b on a.RazonSocial = b.NombreComercial join Asegurados c on b.NombreComercial = a.RazonSocial where a.fecha BETWEEN @fechaini AND @fechafin group by a.RazonSocial, b.Clase, b.Poliza, a.MesFacturacion, a.NumeroFactura, a.ValorFactura, a.ValorNotaCred, a.Banco, a.Cuenta, a.NumCheque, a.ValorCheque, a.Comprobante, a.FechaTransf, a.ValorTransf, a.NumeroFactComi, a.ValorFactComi, a.NumeroReten, a.ValorRetenEmp, a.ValorDebito, a.Deuda"; 
                    ...
                    if (dr2.Read())
                    {
                        ...
                        else
                        {
                            using (XLWorkbook wb = new XLWorkbook())
                            {
                                ...
                                Response.AddHeader("content-disposition", "attachment;filename=ReporteEntregaPagos.xlsx");
